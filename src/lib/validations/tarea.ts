...
export const TareaSchema = z.object({
  ...
  // Checklist. El `id` viene solo en los ítems que ya existían: sirve para
  // conservar si estaban tildados en vez de recrearlos en cada guardado. Los
  // nuevos llegan sin id. El orden del array es el orden en pantalla.
  items: z
    .array(
      z.object({
